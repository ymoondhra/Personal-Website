// Animation Variables
var currentCircles = []; // array of BlueCircle objects
var starttime = null;    // time we started the animation
var fadingAway = false;  // are the bubbles fading away because they are getting reset
var neverStarted = true; // have we ever started the animation
var resetTimeout = null; // ~ ignore for now ~
// Animation Options
var NUM_CIRCLES = 1;   // number of minis desired
var ANIMATION_DURATION = 10000; // how long it will take for minis to travel to their final location
...
class BlueCircle {
  constructor(left, top, width, height, DOMReference = null) {
    ...
    this.recalculateFinalPosition(false); // ~ ignore for now ~
  }
